...
Keyword : int Identifier : main Special Char : ( Special Char : ) Special Char : { Keyword : int Identifier : num Operator : = Literal : 100 Special Char : ; Keyword : return Literal : 0 Special Char : ; Special Char : }
